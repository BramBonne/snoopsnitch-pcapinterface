...
public class MsdConfig {
	...
	public static boolean getPcapSocketEnabled(Context context){
		return sharedPrefs(context).getBoolean("settings_enable_pcap_socket", false);
	}
	public static int getPcapSocketPort(Context context)
	{
		return sharedPrefs(context).getInt("settings_pcap_socket_port", 9742);
	}
}
